$.Controller.extend("Drcom.Video", {
    ...
    _prepareElement: function(){
        ...
        $("<source></source>").attr("type","video/ogg").attr("src",this.element.attr("src")+".ogg").appendTo(video);
		$("<source></source>").attr("type","video/ogg").attr("src",this.element.attr("src")+".ogv").appendTo(video);
        $("<source></source>").attr("type","video/mp4").attr("src",this.element.attr("src")+".mp4").appendTo(video);
