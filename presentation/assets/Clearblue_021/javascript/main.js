(function() {
	$('#slider').on('ready', '.Clearblue_021', function(e, el) {
	...
	/*pop16*/	
			if(isAnimation)
		{
			...
			$('.box_1,.number_1,.txt_box1,.img_box_1',slide).delay(1000).fadeIn(600);
			/*$('.number_1',slide).delay(1500).fadeIn(function(){
				$('.txt_box1',slide).fadeIn(1200);
					$('.img_box_1',slide).delay(600).fadeIn(600);
				
			});*/
			
			$('.box_2,.number_2,.txt_box2,.img_box_2',slide).delay(1500).fadeIn(600);		
			/*$('.number_2',slide).delay(2900).fadeIn(function(){
				$('.txt_box2',slide).fadeIn(1200);
					$('.img_box_2',slide).delay(600).fadeIn(600);
			});*/
			
			
			$('.box_3,.number_3,.txt_box3,.img_box_3',slide).delay(2000).fadeIn(600);
			/*$('.number_3',slide).delay(4400).fadeIn(function(){
				$('.txt_box3',slide).fadeIn(1200);
					$('.img_box_3',slide).delay(600).fadeIn(600);
			});*/
			
			$('.box_4,.number_4,.txt_box4,.img_box_4',slide).delay(2500).fadeIn(600);
			/*$('.number_4',slide).delay(5400).fadeIn(function(){
				$('.txt_box4',slide).fadeIn(1200);
					$('.img_box_4',slide).delay(600).fadeIn(600);
			});*/
		}
		else
		{
