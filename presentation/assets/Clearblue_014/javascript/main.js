(function() {
	$('#slider').on('ready', '.Clearblue_014', function(e, el) {
		var slide = $('#container', el);


		if(isAnimation)
		{
			$(".txt1", slide).delay(100).fadeIn(500);
			$('.txt2').delay(400).animate({opacity: 1,top: '210'}, 500);
			$(".txt3", slide).delay(700).fadeIn(500);
			$('.txt4').delay(1000).animate({opacity: 1,top: '416'}, 500);
	...
	else
		{
			...
			$('.txt1, .txt3',slide).show();
			$('.txt2',slide).css({opacity: 1,top: '210'});
			$('.txt4',slide).css({opacity: 1,top: '416'});
