(function() {
	$('#slider').on('ready', '.Clearblue_022', function(e, el) {
		var slide = $('#container', el);
			if(isAnimation)
			
			
		{    
		$('.box_4',slide).fadeIn(600);
			$('.box_2',slide).delay(600).fadeIn(600, function(){
				$('.box_1',slide).fadeIn(600, function(){
					$('.box_3',slide).fadeIn(600, function(){
						$('.notebook,.btn_pu22',slide).fadeIn(700, function(){
			...
			$(".btn_pu22",slide).drcom_customizepopup({
				closeInside: false,
				closeOutside: false,
				onShow: function(){
					setUpRef('36');	
