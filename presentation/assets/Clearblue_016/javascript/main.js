(function() {
	$('#slider').on('ready', '.Clearblue_016', function(e, el) {
		var slide = $('#container', el);


		if(isAnimation)
		{
			$(".box_1", slide).delay(200).fadeIn(500);
			$(".box_2", slide).delay(1200).fadeIn(500);
			$(".box_3", slide).delay(2200).fadeIn(500);
			$(".img", slide).delay(3200).fadeIn(500);
